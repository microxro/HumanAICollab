...
App.views.flashcards = (function () {
  ...
  function endSession(sessionId, right, wrong, kind) {
    // Reviewing a deck used to pay study tokens. It doesn't any more: the
    // shop has one earning route, and it is a quiz the server marks — see
    // js/shop.js. Turning cards over is still study; it just isn't currency.
    UI.modal({
